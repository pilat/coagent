...
var recommendations = map[string]Recommendation{
	"anthropic":     {Default: "claude-sonnet-5", Onboarding: "claude-sonnet-5"},
	"openrouter":    {Default: "anthropic/claude-sonnet-5", Onboarding: "anthropic/claude-sonnet-5"},
	"google-vertex": {Default: "gemini-3.5-flash", Onboarding: "gemini-3.5-flash"},
	"openai":        {Default: "gpt-5-mini", Onboarding: "gpt-5-mini"},
}
